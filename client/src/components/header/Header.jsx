    ...
    <div className="header">
        ...
        { type !== "list" && 
          <>
            ...
            <p className="headerDesc">Get rewarded for your travels - unlock instant savings of 10% or more with free NextBooking account</p>
            { !user && (
                <Link to={"/login"}>
                ...
                <div className="headerSearchItem">
                    ...
                    {openOptions && <div className="options">
                        ...
                        <div className="optionItem">
                            ...
                            <div className="optionsCount">
                                <button disabled={options.children <=0} className="optionCounterButton" onClick={()=>handleOption("cchildren", "d")}>-</button>
